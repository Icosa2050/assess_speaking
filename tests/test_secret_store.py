...
class SecretStoreTests(unittest.TestCase):
    ...
    @mock.patch("app_core.secret_store._load_keyring_module")
    ...
    def test_get_secret_logs_keyring_read_failures(self, mock_load_keyring):
        ...
        with self.assertLogs("app_core.secret_store", level="WARNING") as logs:
    ...
    @mock.patch("app_core.secret_store.KeyringSecretStore.delete_secret", side_effect=RuntimeError("wrapped failed"))
