...
import app_core.bootstrap as bootstrap_module
from app_core import app_data
from app_core.app_data import (
    APP_AUTHOR,
...
class AppDataTests(unittest.TestCase):
    ...
    def test_legacy_windows_cache_home_does_not_append_cache_segment(self):
        with mock.patch("app_core.app_data.os.name", "nt"), mock.patch.dict(
            os.environ,
    ...
    def test_resolve_app_data_root_prefers_initialized_legacy_root_over_empty_new_root(self):
        with tempfile.TemporaryDirectory() as base_dir:
            ...
            new_root.mkdir()
            with mock.patch("app_core.app_data._default_app_data_root", return_value=new_root.resolve()), mock.patch(
                "app_core.app_data._legacy_default_app_data_root",
    ...
    def test_default_app_data_root_uses_platformdirs_identity(self):
        with mock.patch("app_core.app_data._platform_dirs") as mock_dirs, mock.patch(
            "app_core.app_data._legacy_default_app_data_root",
    ...
    def test_linux_default_roots_follow_xdg_style_locations(self):
        with mock.patch("app_core.app_data._platform_dirs") as mock_dirs, mock.patch(
            ...
            "app_core.app_data._legacy_default_cache_root",
    ...
    def test_bootstrap_rejects_repo_local_default_whisper_cache_dir(self):
        with tempfile.TemporaryDirectory() as project_dir, tempfile.TemporaryDirectory() as app_dir, tempfile.TemporaryDirectory() as cache_dir:
            ...
            with mock.patch("app_core.bootstrap.PROJECT_ROOT", project_root), mock.patch(
                "app_core.bootstrap.build_app_data_paths",
